...
See [Authoring Contracts](/docs/authoring) for side-by-side examples, including
recommended **GiST** indexes on `ltree` columns. The [Getting Started](/docs/getting-started)
guide covers install, runtime wiring, migrations, and your first queries.
