...
| ------------------------------ | -------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `prisma-ltree/control`         | `ltreeExtensionDescriptor` — **default** _and_ named                 | `import ltree from "prisma-ltree/control"`                                      | `prisma-next.config.ts` → `defineConfig({ extensions: [ltree] })`        |
